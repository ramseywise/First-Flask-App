...
def badass():
    ...
    for line in output.split("\n"):
        ...
        return render_template("badass.html", response=image_url, insert=res[1])
...
def badass2():
    ...
    parser.add_argument("keyword", help=res[0])
    ...
    with Pool(processes=args.worker) as pool:
        ...
        return render_template("badass2.html", response=links, insert=res[1])
